...
2. **`ReaderFeature`** — absorbed `Study/`. Six entry points, narrowed to `package` on 2026-08-29 once `RootFeature` moved the composition root inside the package.
