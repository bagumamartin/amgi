...
public struct DeckClient: Sendable {
    ...
    public var customStudyDefaults: @Sendable (_ deckId: DeckID) async throws -> CustomStudyDefaults
    public var customStudy: @Sendable (_ deckId: DeckID, _ request: CustomStudyRequest) async throws -> CustomStudyResult
